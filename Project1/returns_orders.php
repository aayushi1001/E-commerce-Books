    ...
    if (mysqli_num_rows($name)>0) {
       ...
       <?php
        ...
        <div class="row">
          ...
          <br><div class="col-lg-7"><strong class='text-dark h1-responsive font-weight-normal mb-3'>No orders Yet!</strong> <br>
         <a class='h5 font-weight-normal text-danger link_decor' href='home.php'>click here to place orders</a></div>
        </div>
        <?php
      }
    ?>
